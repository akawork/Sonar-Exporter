...
def make_metrics(system_info):
    ...
    metric = GaugeMetricFamily(
        'sonar_system_compute_memory_max',
    ...
    metric = GaugeMetricFamily(
        'sonar_system_compute_memory_free',
    ...
    metric = GaugeMetricFamily(
        'sonar_system_search_file_desc_open',
    ...
    metric = GaugeMetricFamily(
        'sonar_system_search_file_desc_max',
    ...
    metric = GaugeMetricFamily(
        'sonar_system_search_disk_available',
